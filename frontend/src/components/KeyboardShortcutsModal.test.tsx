...
describe('KeyboardShortcutsModal', () => {
  ...
  test('affiche tous les raccourcis', () => {
    ...
    expect(screen.getByText(/début \/ fin de la vidéo/i)).toBeInTheDocument()
    expect(screen.getByText(/créer \/ supprimer une annotation/i)).toBeInTheDocument()
    expect(screen.getByText(/lecture \/ pause/i)).toBeInTheDocument()
    expect(screen.getByText(/activer \/ désactiver le bip/i)).toBeInTheDocument()
    expect(screen.getByText(/supprimer l'annotation sélectionnée/i)).toBeInTheDocument()
